...
- **Clone your GitHub repo**
  ...
  ```bash
  git clone https://github.com/P1yushhhh/Study-buddy-AI.git
  ls
  cd Study-buddy-AI
      ...
      stages {
          stage('Checkout Github') {
              steps {
                  ...
                  checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-token', url: 'https://github.com/P1yushhhh/Study-buddy-AI.git']])
              }
          }        
...
2. Create a new repository, e.g., `P1yushhhh/study-buddy`
...
1. Go to **Jenkins → Manage Jenkins → Credentials → Global → Add Credentials**
   - **Username**: DockerHub username (e.g., `iblamepiyush`)
...
`https://hub.docker.com/r/iblamepiyush/study-buddy`
...
2. Fill in details:
   ...
   * **Project:** default
   * **Repo URL:** `https://github.com/P1yushhhh/Study-buddy-AI.git`
...
* You should see your `studybuddy-app` deployment.
* Check pods:
...
```bash
kubectl port-forward svc/studybuddy-service -n argocd --address 0.0.0.0 9090:80
```
...
* You should see your `studybuddy-app` running successfully!
